                        ...
                        <div class="card-box">
                            ...
                            <form  id="edit_cpu">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id" id="id" className="form-control" value="{{$cpu -> id}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gen" id="gen" placeholder="Ví dụ: 5 - Tên thế hệ..." class="form-control" value="{{$cpu->gen}}">
                                            @error('gen')
                                            <p class="alert text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="integrated_gpu" placeholder="Ví dụ: UHD 620 Graphic..." id="integrated_gpu" class="form-control" value="{{$cpu->integrated_gpu}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="release_date" id="release_date" class="form-control" value="{{$cpu->release_date}}">
                                            @error('release_date')
                                            <p class="alert text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-button text-center">
                                    <button type="submit" class="btn btn-primary edit_cpu" data-href ="{{route('cpus.view')}}" data-url="{{route('cpus.update', ['id'=>$cpu->id])}}">Update</button>
                                </div>
                            </form>
                            <!-- end col-->
                        </div>
