                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col form-group col-md-8 @error('title') has-error @enderror">
                                                            ...
                                                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Nhập tên bài viết" value="{{$blogs->title}}">
                                                            @error('title')
                                                        ...
                                                        <div class="col form-group col-md-6">
                                                            ...
                                                            <span>Xem trước: </span>
                                                            <img  style="margin-top: 10px;" id="image_upload" width="150px" height="150px" src="{{$blogs->title_image_path}}">
                                                        </div>
                                                        <div class="col form-group col-md-8">
                                                            <div class="form-group @error('meta_keyword') has-error @enderror">
                                                                <label for="">Từ khóa seo: </label>
                                                                <input type="text" name="meta_keyword" id="" placeholder="Danh sách từ khóa" class="form-control select1_init" value="{{$blogs->meta_keyword}}">
                                                                @error('meta_keyword')
                                                                <div class="alert alert-danger">{{ $message }}
                                                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                </div>
                                                        ...
                                                        <div class="col form-group col-md-8">
                                                            <div class="form-group @error('meta_description') has-error @enderror">
                                                                ...
                                                                <input type="text" name="meta_description" id="" placeholder="Mô tả ngắn bài viết" class="form-control" value="{{$blogs->meta_description}}">
                                                        ...
                                                        <div class="col form-group col-md-8">
                                                            <div class="form-group @error('contents') has-error @enderror">
                                                                ...
                                                                <textarea  rows="10" class="form-control tinymce_editor_init  @error('contents') is-invalid @enderror error-messages" rows="10" name="contents" id="editor_init" placeholder="Mô tả sản phẩm..." value="">{{$blogs->content}}</textarea>
                                                                @error('contents')
                                                                <div class="alert alert-danger">{{ $message }}
                                                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                </div>
                                                        ...
                                                        <div class="col form-group col-md-6">
                                                            ...
                                                            <div class="checkbox">
                                                                <div class="custom-control custom-radio">
                                                                    <input class="custom-control-input" value="1" type="radio" id="active" name="status" {{$blogs->status== 1 ? 'checked' : ''}}>
                                                                    <label for="active" class="custom-control-label">Hiển thị</label>
                                                                </div>
                                                                <div class="custom-control custom-radio">
                                                                    <input class="custom-control-input" value="0" type="radio" id="no_active" name="status" {{$blogs->status== 0 ? 'checked' : ''}}>
                                                ...
                                                <div class="card-footer">
                                                    <div class="row justify-content-md-center">
                                                        <button type="submit" class="btn btn-primary mr-sm-4">Cập nhập</button>
