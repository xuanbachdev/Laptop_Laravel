! function(t) {
    ...
    e.prototype.init = function() {
        t("#sa-basic").on("click", function() {
            ...
            }), t("#sa-image").click(function() { Swal.fire({ title: "Minton", text: "Responsive Bootstrap 4 Admin Dashboard", imageUrl: "assets/images/logo-sm-dark.png", imageHeight: 50, animation: !1, confirmButtonClass: "btn btn-confirm mt-2" }) }), t("#sa-close").click(function() {
                var t;
